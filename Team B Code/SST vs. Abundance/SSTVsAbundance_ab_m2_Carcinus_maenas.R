...
SSTTable <- cbind(TotalData$SST, TotalData$ab_m2_Carcinus_maenas)
...
FigureTable<- ddply(TotalData,.(SST),summarize,
                    ...
                    NAbundance=sum(is.na(ab_m2_Carcinus_maenas)==F)
)
###### Make Graph ########
jpeg('SSTAbundanceab_m2_Carcinus_maenas.jpeg', height=1200, width=2400, res=400, qual=100 )
