...
SSTTable <- cbind(TotalData$SST, TotalData$pc_Ulva_.something...)
...
mp <- barplot(AB_mean, names.arg=FigureTable$SST, xlab="SST", ylab= expression ("Percent coverage (%)"), main=" ",ylim=c(0,1)) # plots the barplot and saves the midpoints in mp
