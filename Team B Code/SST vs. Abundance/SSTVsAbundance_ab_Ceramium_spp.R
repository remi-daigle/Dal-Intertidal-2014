...
SSTTable <- cbind(TotalData$SST, TotalData$ab_Ceramium_spp)
...
FigureTable<- ddply(TotalData,.(SST),summarize,
                    ...
                    SDAbundance=sd(ab_Ceramium_spp/Quadrat_m2,na.rm = TRUE),
                    NAbundance=sum(is.na(ab_Ceramium_spp)==F)
)
###### Make Graph ########
jpeg('SSTAbundanceab_Ceramium_spp.jpeg', height=1200, width=2400, res=400, qual=100 )
