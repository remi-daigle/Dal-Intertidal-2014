...
SSTTable <- cbind(TotalData$SST, TotalData$ab_m2_Chondrus.crispus)
...
###### Make Graph ########
jpeg('SSTAbundanceab_m2_Chondrus.crispus.jpeg', height=1200, width=2400, res=400, qual=100 )
...
jpeg('SSTAbundanceab_m2_Chondrus.crispus.jpeg', height=1200, width=2400, res=400, qual=100 )
mp <- barplot(FigureTable$MeanAbundance, names.arg=FigureTable$SST, xlab="SST", ylab= expression ("Abundance (Ind/m"^2*")"), main=" ",ylim=c(0,1)) # plots the barplot and saves the midpoints in mp
