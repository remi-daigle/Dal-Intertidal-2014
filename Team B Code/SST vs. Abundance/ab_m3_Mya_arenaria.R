...
SSTTable <- cbind(TotalData$SST, TotalData$ab_m3_Mya_arenaria)
...
jpeg('SSTAbundance1.jpeg', height=1200, width=2400, res=400, qual=100 )
mp <- barplot(FigureTable$MeanAbundance, names.arg=FigureTable$SST, xlab="SST", ylab= expression ("Abundance (Ind/m"^3*")"), main=" ",ylim=c(0,5)) # plots the barplot and saves the midpoints in mp
