...
SSTTable <- cbind(TotalData$SST, TotalData$pc_Fucus_vesiculosus)
...
mp <- barplot(AB_mean, names.arg=FigureTable$SST, xlab="SST", ylab= expression ("Percent coverage (%)"), main=" ",ylim=c(0,20)) # plots the barplot and saves the midpoints in mp
