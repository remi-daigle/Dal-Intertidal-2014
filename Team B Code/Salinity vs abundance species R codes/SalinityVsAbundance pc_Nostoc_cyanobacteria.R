...
SSTTable <- cbind(TotalData$Salinity, TotalData$pc_Nostoc_cyanobacteria)
...
mp <- barplot(AB_mean, names.arg=FigureTable$Salinity, xlab="Salinity", ylab= expression ("Percent coverage (%)"), main=" ",ylim=c(0,25)) # plots the barplot and saves the midpoints in mp
