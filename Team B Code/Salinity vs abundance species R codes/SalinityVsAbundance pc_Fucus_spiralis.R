...
SalinityTable <- cbind(TotalData$Salinity, TotalData$pc_Fucus_spiralis)
...
FigureTable<- ddply(TotalData,.(Salinity),summarize,
                MeanAbundance=mean(pc_Fucus_spiralis/Quadrat_m2,na.rm = TRUE),
                SDAbundance=sd(pc_Fucus_spiralis/Quadrat_m2,na.rm = TRUE),
                NAbundance=sum(is.na(pc_Fucus_spiralis)==F)
)
