...
SSTTable <- cbind(TotalData$Salinity, TotalData$pc_Hildenbrandia_spp.)
...
mp <- barplot(AB_mean, names.arg=FigureTable$Salinity, xlab="Salinity", ylab= expression ("Percent coverage (%)"), main=" ",ylim=c(0,35)) # plots the barplot and saves the midpoints in mp
