...
SlopeTable <- cbind(TotalData$Slope, TotalData$pc_Nostoc_cyanobacteria)
...
FigureTable<- ddply(TotalData,.(Slope),summarize,
                    MeanPercentCoverage=mean(ppc_Nostoc_cyanobacteria,na.rm = TRUE),
...
jpeg('Slopepc_Nostoc_cyanobacteria.jpg', height=1200, width=2400, res=400, qual=100 )
