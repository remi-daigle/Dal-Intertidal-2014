...
SlopeTable <- cbind(TotalData$Slope, TotalData$pc_Fucus_distichous_attached)
...
jpeg('Slopepc_Fucus_distichous_attached.jpg', height=1200, width=2400, res=400, qual=100 )
