...
SWHTable <- cbind(TotalData$SWH, TotalData$ab_m3_Glycera_dibrachiata)
...
jpeg(file = paste(SaveHere, "SWHab_m3_Glycera_dibrachiata.jpg"), height=1200, width=2400, res=400, qual=100  )
