...
SWHTable <- cbind(TotalData$SWH, TotalData$ab_m2_Chiridotea_coeca)
...
jpeg(file = paste(SaveHere, "SWHab_m2_Chiridotea_coeca.jpg"), height=1200, width=2400, res=400, qual=100  )
