...
SWHTable <- cbind(TotalData$SWH, TotalData$ab_m2_Hiatella.artica)
...
jpeg(file = paste(SaveHere, "SWHab_m2_Hiatella.artica.jpg"), height=1200, width=2400, res=400, qual=100  )
