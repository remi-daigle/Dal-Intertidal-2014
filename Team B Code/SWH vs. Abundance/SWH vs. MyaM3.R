...
FigureTable<- ddply(TotalData,.(SWH),summarize,
                    ...
                    SDAbundance=sd(ab_m3_Mya_arenaria/Core_m3,na.rm = TRUE)
)

### Make SWH Table ####

#Bind salinity and abundance in data table
SWHTable <- cbind(TotalData$SWH, TotalData$ab_m3_Mya_arenaria)
...
jpeg(file = paste(SaveHere, "SWHab_m3_Mya_arenaria.jpg"), height=1200, width=2400, res=400, qual=100  )
