...
FigureTable<- ddply(TotalData,.(SWH),summarize,
                    MeanAbundance=mean(pc_Fucus_vesiculosus/Quadrat_m2,na.rm = TRUE)*100,
                    SDAbundance=sd(pc_Fucus_vesiculosus/Quadrat_m2,na.rm = TRUE)*100
)
...
jpeg(file = paste(SaveHere, "SWHpc_Fucus_vesiculosus.jpg"), height=1200, width=2400, res=400, qual=100  )
