...
FigureTable<- ddply(TotalData,.(SWH),summarize,
                    MeanAbundance=mean(ab_m3_Asterias.spp./Core_m3,na.rm = TRUE),
...
SWHTable <- cbind(TotalData$SWH, TotalData$ab_m3_Asterias.spp.)
...
jpeg('SWHAbundanceAsteriasM3.jpg', height=1200, width=2400, res=400, qual=100  )
