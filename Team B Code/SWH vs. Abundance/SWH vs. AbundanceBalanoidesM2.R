...
jpeg('SWHAbundanceBalanoidesM2', height=1200, width=2400, res=400, qual=100  )
mp <- barplot(FigureTable$MeanAbundance, names.arg=FigureTable$SWH, xlab="Standard Wave Height", ylab= expression ("Abundance (Ind/m"^2*")"), main=" ",ylim=c(0,2000))              # plots the barplot and saves the midpoints in mp
