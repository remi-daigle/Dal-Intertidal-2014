...
table_means <- ddply(Bio,.(Strata),summarize,
                     ...
                     ab_m2_Hiatella.artica_abundance=mean(ab_m2_Hiatella.artica/Quadrat_m2),
                     #Core Samples#
...
table_sd <- ddply(Bio,.(Strata),summarize,
                  ...
                  ab_m2_Hiatella.artica_abundance=sd(ab_m2_Hiatella.artica/Quadrat_m2),
                  #Core Samples#
...
sp_names <- c("","Mytilus","Semi_Bal", "Littorina", "Pagurus", "Carcinus", "Chondrus", "Hiatella",
              "Arenaria_core","Mytilus_core","Semi_Bal_core", "Pagurus_core", "Glycera_core", "Asterias_core")
